...
## The Flash sample app
This sample app uses the Realtime® Framework Pub/Sub ActionScript3 library to connect, send and receive messages through a Realtime® Server in the cloud.

![ScreenShot](http://ortc.xrtml.org/screenshots/2.1.0/ActionScript/ApiUsageFlash/Screen.jpg)

Due to Flash security restrictions you must run this sample from a webserver (e.g. localhost).
