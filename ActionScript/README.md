...
## The AS3, Flex, and Air sample apps
These samples apps use the Realtime® Framework Pub/Sub ActionScript3 library to connect, send and receive messages through a Realtime® Server in the cloud.

In fact these samples are fully functional developer consoles. They are very useful to debug your Realtime applications (e.g. subscribing channels to inspect the content of messages published by other applications).

![ScreenShot](http://ortc.xrtml.org/screenshots/2.1.0/ActionScript/ApiUsageAir/Screen.jpg)
